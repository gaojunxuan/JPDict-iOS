...
const tileWidth =
  Dimensions.get("window").width - (Platform.OS === "android" ? 40 : 24);
...
export default class ResultScreen extends React.Component {
      ...
      headerRight: (
        ...
        >
          <Ionicons
            name={
              params.isInNotebook
                ? `${Platform.OS === "ios" ? "ios" : "md"}-trash`
                : `${Platform.OS === "ios" ? "ios" : "md"}-bookmark`
            }
  ...
  setNavigationOptions() {
    this.props.navigation.setOptions({
      title: "释义 - " + this.props.route.params?.keyword ?? "",
      headerStyle: {
      ...
      headerRight: () => (
        <TouchableOpacity
          onPress={
            this.state.isInNotebook
              ? () => this.removeFromNotebook()
              : () => this.addToNotebook()
          }
        >
          <Ionicons
  ...
  runQuery() {
    var id = this.props.route.params?.itemId ?? "0";
    var keyword = this.props.route.params?.keyword ?? "";
      ...
      if (
        ...
        this.setState({
          verbResult: {
            ...
            NegativeCausative: VerbConjugationHelper.GetNegativeCausative(
              keyword,
              pos
            ),
            NegativeForm: VerbConjugationHelper.GetNegative(keyword, pos),
            NegativeImperative: VerbConjugationHelper.GetNegativeImperative(
              keyword
            ),
            NegativePassive: VerbConjugationHelper.GetNegativePassive(
              keyword,
              pos
            ),
            NegativePotential: VerbConjugationHelper.GetNegativePotential(
              keyword,
              pos
            ),
  ...
  queryKanjiResult(keyword) {
    keyword.forEach((element) => {
      QueryHelper.queryKanji(element, (_array) => {
        ...
        kanjiResult[_array[0].Kanji] = {
          kun: _array[0].KunReading,
          on: _array[0].OnReading,
        };
  ...
  removeFromNotebook() {
    this.setState({ isInNotebook: false });
      ...
      <View style={styles.container}>
        ...
        <Swiper activeDotColor="#00b294">
          <ScrollView style={{ flex: 1 }}>
            ...
            >
              <ActivityIndicator
                animating={this.state.queryBusy}
                size="small"
                color="#00b294"
              />
            </View>
            ...
            >
              <View style={{ flexDirection: "row", alignItems: "center" }}>
                <Text
                  style={{ fontSize: 24, color: "#00b294", marginRight: 8 }}
                >
                  {this.state.keyword}
                </Text>
                <TouchableOpacity
                  onPress={() => {
                    Speech.speak(Object(this.state.result[0]).Reading, {
                      language: "ja",
                      rate: 0.5,
                    });
                  }}
                >
                  <Ionicons
                    name={`${Platform.OS === "ios" ? "ios" : "md"}-volume-high`}
                    color="#00b294"
                    size={32}
                  />
                </TouchableOpacity>
              ...
              <View style={{ marginTop: 24 }}>
                ...
                <Text style={{ fontSize: 20, marginTop: 8 }}>
                  {Object(this.state.result[0]).Reading}
                </Text>
              </View>
              <HideableView
                hide={!this.state.hasKanji}
                style={{ marginTop: 24 }}
              >
                <Text style={{ color: "gray", fontSize: 12 }}>汉字</Text>
                <Text style={{ fontSize: 20, marginTop: 8 }}>
                  {Object(this.state.result[0]).Kanji}
                </Text>
              </HideableView>
              <HideableView
                hide={!this.state.hasLoanWord}
                style={{ marginTop: 24 }}
              >
                <Text style={{ color: "gray", fontSize: 12 }}>外来语</Text>
                <Text style={{ fontSize: 20, marginTop: 8 }}>
                  {Object(this.state.result[0]).LoanWord}
                </Text>
              </HideableView>
              <HideableView
                hide={!this.state.hasSeeAlso}
                style={{ marginTop: 24 }}
              >
                <Text style={{ color: "gray", fontSize: 12 }}>另见</Text>
                <Text style={{ fontSize: 20, marginTop: 8 }}>
                  {Object(this.state.result[0]).SeeAlso}
                </Text>
              </HideableView>
                    ...
                    >
                      ...
                      >
                        ...
                        <View style={{ marginLeft: 12 }}>
                          <Text style={{ width: tileWidth - 64 }}>
                            {Object(this.state.kanjiResult[k]).kun}
                          </Text>
                          <Text style={{ width: tileWidth - 64, marginTop: 4 }}>
                            {Object(this.state.kanjiResult[k]).on}
                          </Text>
                        </View>
                      </View>
                    </TouchableBounce>
              ...
              >
                ...
                >
                  <Text
                    style={{ fontSize: 16, color: "darkgray", marginRight: 4 }}
                  >
                    辞书形：
                  </Text>
                  <Text style={{ fontSize: 16, flex: 1, flexWrap: "wrap" }}>
                    {this.state.verbResult.OriginalForm}
                  </Text>
                </View>
                <View
                  style={{
                ...
                >
                  ...
                  <Text style={{ fontSize: 16, flex: 1, flexWrap: "wrap" }}>
                    {this.state.verbResult.Potential}
                  </Text>
                </View>
                <View
                  style={{
                ...
                >
                  ...
                  <Text style={{ fontSize: 16, flex: 1, flexWrap: "wrap" }}>
                    {this.state.verbResult.Causative}
                  </Text>
                </View>
                <View
                  style={{
                ...
                >
                  ...
                  <Text style={{ fontSize: 16, flex: 1, flexWrap: "wrap" }}>
                    {this.state.verbResult.Imperative}
                  </Text>
                </View>
                <View
                  style={{
                ...
                >
                  ...
                  <Text style={{ fontSize: 16, flex: 1, flexWrap: "wrap" }}>
                    {this.state.verbResult.Volitional}
                  </Text>
                </View>
                ...
                >
                  ...
                  <Text style={{ fontSize: 16, flex: 1, flexWrap: "wrap" }}>
                    {this.state.verbResult.NegativeForm}
                  </Text>
                </View>
                <View
                  style={{
                ...
                >
                  ...
                  <Text style={{ fontSize: 16, flex: 1, flexWrap: "wrap" }}>
                    {this.state.verbResult.NegativePotential}
                  </Text>
                </View>
                <View
                  style={{
                ...
                >
                  ...
                  <Text style={{ fontSize: 16, flex: 1, flexWrap: "wrap" }}>
                    {this.state.verbResult.NegativePassive}
                  </Text>
                </View>
                <View
                  style={{
                ...
                >
                  ...
                  <Text style={{ fontSize: 16, flex: 1, flexWrap: "wrap" }}>
                    {this.state.verbResult.NegativeCausative}
                  </Text>
                </View>
                <View
                  style={{
                ...
                >
                  ...
                  <Text style={{ fontSize: 16, flex: 1, flexWrap: "wrap" }}>
                    {this.state.verbResult.NegativeImperative}
                  </Text>
                </View>
                ...
                >
                  ...
                  <Text style={{ fontSize: 16, flex: 1, flexWrap: "wrap" }}>
                    {this.state.verbResult.MasuForm}
                  </Text>
                </View>
                <View
                  style={{
                ...
                >
                  ...
                  <Text style={{ fontSize: 16, flex: 1, flexWrap: "wrap" }}>
                    {this.state.verbResult.MasuNegative}
                  </Text>
                </View>
              </HideableView>
            </Animated.View>
