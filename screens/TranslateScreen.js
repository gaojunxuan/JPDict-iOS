...
import { View, Button, TextInput, Text, StyleSheet, ScrollView, Clipboard, StatusBar, TouchableOpacity } from 'react-native';
                ...
                <View style={styles.ineerContainer}>
                    <View style={{flexDirection: "row"}}>
                        ...
                        <View style={{marginLeft: 24, alignSelf: 'center', flexDirection: 'row'}}>
                            <Button title="清空" color="#00b294" onPress={() => this.setState({originText: ""})} style={{ marginRight: 8 }}/>
                    ...
                    <TextInput multiline style={styles.input} placeholder="输入或粘贴要翻译的内容" selectionColor='#00b294' onChangeText={(text) => this.setState({originText: text})} value={this.state.originText}>
                    </TextInput>
                </View>
                <View style={styles.ineerContainer}>
                    <View style={{flexDirection: "row"}}>
                    ...
                    <TextInput multiline style={styles.input} editable={false} placeholder="翻译结果将显示在此处" selectionColor='#00b294' value={this.state.resultText}>
                    </TextInput>
                </View>
            </ScrollView>
        );
