      ...
      <KeyboardAvoidingView style={{ flex: 1 }} behavior="padding">
        ...
        >
          ...
          <View style={{ flexDirection: "row", marginBottom: 24 }}>
            <TouchableOpacity
              onPress={() => {
                this.setState({ srclang: "jp" });
              }}
              style={{
                backgroundColor:
                  this.state.srclang == "jp" ? "#00b294" : "lightgray",
                borderRadius: 24,
                height: 32,
                width: 64,
            ...
            >
              <Text
                style={{
                  color: this.state.srclang == "jp" ? "white" : "black",
                }}
              >
                日 → 中
              </Text>
            ...
            <TouchableOpacity
              onPress={() => {
                this.setState({ srclang: "zh" });
              }}
              style={{
                backgroundColor:
                  this.state.srclang == "zh" ? "#00b294" : "lightgray",
                borderRadius: 24,
                height: 32,
                width: 64,
                justifyContent: "center",
            ...
            >
              <Text
                style={{
                  color: this.state.srclang == "zh" ? "white" : "black",
                }}
              >
                中 → 日
              </Text>
              ...
              >
                <View style={{ marginRight: 8 }}>
                  <Button
                    title="清空"
                    color="#00b294"
                    onPress={() => this.setState({ originText: "" })}
                  />
                </View>
                <View>
                  <Button
                    ...
                    onPress={() => {
                      if (
                        this.state.originText != null &&
                        this.state.originText.trim() != ""
                      ) {
                        var dst = this.state.srclang == "jp" ? "zh" : "jp";
                        HttpRequestHelper.translate(
                          utf8.encode(this.state.originText),
                          this.state.srclang,
                          dst,
                          (result) => {
                            var result_str = "";
            ...
            <View style={{ flexDirection: "row" }}>
              ...
              <View style={{ marginLeft: 24, alignSelf: "center" }}>
                <Button
                  title="复制"
                  color="#00b294"
                  onPress={() => Clipboard.setString(this.state.resultText)}
                />
              </View>
            </View>
            <TextInput
