...
export default class KanjiScreen extends React.Component {
  ...
  constructor(props) {
    ...
    this.props.navigation.addListener("focus", () => {
      var keyword = this.props.route.params?.keyword ?? "一";
  ...
  queryKanji(keyword) {
    QueryHelper.queryKanji(keyword, (_array) => {
      ...
      var result = {
        kun: queryresult.KunReading,
        on: queryresult.OnReading,
        strokes: queryresult.Strokes,
        grade: queryresult.Grade,
        jlpt: queryresult.Jlpt,
      };
  ...
  render() {
    return (
      <ScrollView style={styles.container}>
        ...
        >
          <Text style={{ fontSize: 48, color: "#00b294", fontWeight: "300" }}>
            {this.state.keyword}
          </Text>
          <View
            style={{
